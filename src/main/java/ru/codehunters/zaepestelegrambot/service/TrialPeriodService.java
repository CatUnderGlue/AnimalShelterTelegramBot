...
public interface TrialPeriodService {
     ...
     * @throws NotFoundException Если в базе нет испытательного срока с указанным id
     */
     ...
     * @throws NotFoundException Если база с испытательными сроками пустая
     */
     ...
     * @throws NotFoundException Если у пользователя отсутствуют испытательные сроки
     */
     ...
     * @throws NotFoundException Если у передаваемого испытательного срока нет id или в базе нет испытательного срока с указанным id
     */
