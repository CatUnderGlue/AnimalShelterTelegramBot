...
public interface ReportService {
     ...
     * @param id id отчёта
     * @return Отчёт
     * @throws NotFoundException Если в базе нет отчёта с указанным id
     */
     ...
     * @return Отчёт
     * @throws NotFoundException Если в базе нет отчёта с указанным id и датой
     */
     ...
     * @throws NotFoundException Если база с отчётами пустая
     */
    List<Report> getAll();
     ...
     * @throws NotFoundException Если в базе нет отчётов по указанному id испытательного срока
     */
     ...
     * @throws NotFoundException Если у передаваемого отчёта нет id или в базе нет отчёта с указанным id
     */
     ...
     * @throws AlreadyExistsException   Если отчёт уже отправляли в этот день
     */
